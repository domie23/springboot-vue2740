                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 jingdianNameDiv">
                                        <label>景点名称</label>
                                        <input style="width: 450px" id="jingdianName" name="jingdianName" class="form-control"
                                               placeholder="景点名称">
                                    </div>
                                    <div class="form-group col-md-6 jingdianPhotoDiv">
                                        <label>景点照片</label>
                                    ...
                                    <div class="form-group col-md-6 jingdianTypesDiv">
                                        <label>景点类型</label>
                                        <select style="width: 450px" id="jingdianTypesSelect" name="jingdianTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 jingdianAddressDiv">
                                        <label>景点地址</label>
                                        <input style="width: 450px" id="jingdianAddress" name="jingdianAddress" class="form-control"
                                               placeholder="景点地址">
                                    </div>
                                    <div class="form-group col-md-6 menpiaoMoneyDiv">
                                        <label>门票价格</label>
                                        <input style="width: 450px" id="menpiaoMoney" name="menpiaoMoney" class="form-control"
                                               onchange="menpiaoMoneyChickValue(this)" placeholder="门票价格">
                                    </div>
                                    <div class="form-group  col-md-6 jingdianContentDiv">
                                        <label>景点介绍</label>
...
<script>
    ...
    function getContent() {
        ...
        if($("#jingdianContentupload").length>0) {
            ...
            if (jingdianContentEditor.hasContents()) {
                $('#jingdianContent-input').attr('value', jingdianContentEditor.getContent());
            }
        }
    }
    //数字检查
        <!-- 当前表的数字检查 -->
        function menpiaoMoneyChickValue(e){
        ...
        function jingdianClicknumChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[1-9][0-9]*$/;
            if(!reg.test(this_val)){
                e.value = "";
        ...
        function jingdianDeleteChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[1-9][0-9]*$/;
            if(!reg.test(this_val)){
                e.value = "";
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                jingdianAddress: "required",
                // menpiaoMoney: "required",
                jingdianClicknum: "required",
                shangxiaTypes: "required",
                jingdianContent: "required",
            },
            messages: {
                jingdianName: "景点名称不能为空",
                jingdianPhoto: "景点照片不能为空",
                jingdianTypes: "景点类型不能为空",
                jingdianAddress: "景点地址不能为空",
                // menpiaoMoney: "门票价格不能为空",
                jingdianClicknum: "点击次数不能为空",
                shangxiaTypes: "是否上架不能为空",
                jingdianContent: "景点介绍不能为空",
            }
        }).form();
    }
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            // 门票价格设置不可选
            $('#menpiaoMoney').attr('readonly', 'readonly');
        }
        else{
            // alert("未知情况.......");
