                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 jingdianLiuyanTextDiv">
                                        <label>留言内容</label>
                                        <textarea style="width: 450px"  id="jingdianLiuyanText" name="jingdianLiuyanText" class="form-control"placeholder="留言内容"></textarea>
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                jingdianId: "required",
                yonghuId: "required",
                jingdianLiuyanText: "required",
                replyText: "required",
            },
            messages: {
                jingdianId: "景点不能为空",
                yonghuId: "用户不能为空",
                jingdianLiuyanText: "留言内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#jingdianLiuyanText").val(ruleForm.jingdianLiuyanText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#jingdianLiuyanText').attr('readonly', 'readonly');
