        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="dataStyle">
                        <figure v-for="(item,index) in jingdianList" v-bind:key="index" class="effect-bubba">
                            <img :src="item.jingdianPhoto?item.jingdianPhoto.split(',')[0]:''"  style="height: 350px;width:100%;" />
                            <figcaption>
                                <h2><span>{{item.jingdianName}}</span></h2>
                                <p v-if="item.jingdianNewMoney != null" >￥{{item.jingdianNewMoney}}</p>
                                <a @click="jumpCheck('../jingdian/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" >View more</a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
