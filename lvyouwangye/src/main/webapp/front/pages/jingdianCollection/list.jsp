                    ...
                    <form class="layui-form" lay-filter="myForm">
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="jingdianName" id="jingdianName" placeholder="景点名称" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                        ...
                        <div class="team-info">
                            <div class="team-row">
                                <div v-for="(item,index) in dataList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 team-grids">
                                    <i @click="deleteJingdianCollection(item.id)" class="layui-icon" style="float:right;color:red;margin-top: 0px;margin-right: 3px;font-size:20px">&#xe640;</i>
                                    <div class="team-agile-img" @click="jumpCheck('../jingdian/detail.jsp?id='+item.jingdianId , item.jingdianDelete == null?'':item.jingdianDelete , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img :src="item.jingdianPhoto?item.jingdianPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                        <div class="view-caption">
                                            <div class="w3ls-info">
                                                <h4>{{item.jingdianName}}</h4>
                                            </div>
                                            <b v-if="item.jingdianNewMoney" style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
                                                {{item.jingdianNewMoney}} RMB
                                            </b>
...
<script>
    ...
    // 当前表的字典表
        ...
        function jingdianCollectionTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=jingdian_collection_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.jingdianCollectionTypesList = res.data.list;
                }
            });
        }
    ...
    // 级联表的字段数据
        ...
        function pageList() {
            ...
            //收藏只能查类型为1的
            param['jingdianCollectionTypes'] = 1;

            // 获取列表数据
            http.request('jingdianCollection/page', 'get', param, function(res) {
